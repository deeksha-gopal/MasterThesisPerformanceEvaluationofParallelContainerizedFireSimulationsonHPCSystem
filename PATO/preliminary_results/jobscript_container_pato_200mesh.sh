#!/bin/bash
#SBATCH --job-name=pato_8m_container_explicit_mpi
#SBATCH --output=/beegfs/gopal/new/pato/logs/pato_8m_container_explicit_mpi_%j.out
#SBATCH --error=/beegfs/gopal/new/pato/logs/pato_8m_container_explicit_mpi_%j.err
