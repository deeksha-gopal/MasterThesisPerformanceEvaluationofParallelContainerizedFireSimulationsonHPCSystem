...
CASE_ROOT="${RESULT_ROOT}/smallPoolFire3D_host_SMPI_${NODES}node_${JOB_ID}"
...
case "$NODES" in
    ...
    2) PROCS_LIST="2 4 8 10 16 20 32 40 50 64 80 100" ;;
    4) PROCS_LIST="4 8 16 20 32 40 64 80 100 128 160 200" ;;
    *)
