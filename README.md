...
The `preliminary` directories contain earlier benchmark configurations used during the development of the experimental methodology, including different mesh sizes and standard and explicit MPI execution configurations.
